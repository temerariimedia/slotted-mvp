...
export const PricingPlans: React.FC<PricingPlansProps> = ({ onPlanSelected, currentUserEmail }) => {
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get comprehensive company DNA analysis with our AI-powered tools. Start with a single
            analysis or save with bulk packages.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="mt-4 text-xs text-gray-500">
                  <p>
                    • {plan.limitations.analysesPerMonth} analysis
                    {plan.limitations.analysesPerMonth !== 1 ? 'es' : ''}
                  </p>
                  <p>
                    •{' '}
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">30 Minutes vs 30 Hours</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Latest AI Technology</h4>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Secure & Professional</h4>
              <p className="text-gray-600">
